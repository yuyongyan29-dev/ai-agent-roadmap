...
> 版本：2026-09-10 · 主线 37 周 · 每周 20 小时（其中 16 小时用在单元上）· 单元总时长约 606 小时
...
| 阶段 | 主题 | 周次 | 单元时长 | 里程碑产出 |
|---|---|---|---|---|
| S0 | 工程地基 | W1–W6 | 93h | M0 带测试和 Docker 的 REST API |
...
**关于 37 周这个数字。** 上一版写的是 27 周，那是算错的：README 自己的节奏表是「输入 5 + 动手 11 + 复盘 4」，真正用在单元上的是每周 16 小时，而阶段总时长是 606 小时，606 ÷ 16 = 38 周。**上一版从一开始就超配了 23%。**
